...
|-----------|----------|----------|
| Research, source synthesis, topic scouting | Dinesh | Find sources, produce research briefs, check existing coverage, flag duplicates |
| Editorial backlog, issue triage, prioritization | Jared | Create/triage GitHub Issues, recommend next post, manage pipeline labels |
...
|-----------|---------|----------|
| Source synthesis, topic scouting | Dinesh | — |
| Editorial backlog, issue triage | Jared | — |
| Technical writing, blog drafts | Richard | — |
| Quality review, tone consistency | Monica | — |
| Visual direction, image curation | Erlich | — |
| Jekyll, automation, infrastructure | Gilfoyle | — |
